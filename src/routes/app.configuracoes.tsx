      ...
      {isLoading ? (
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(135deg, oklch(0.55 0.18 250) 0%, oklch(0.45 0.14 245) 100%)",
            }}
          >
          ...
          <Tabs defaultValue="perfil" className="w-full">
            ...
            <TabsContent value="perfil" className="space-y-6">
              ...
              <div className="card-elevated p-6 space-y-5">
                ...
                <p className="text-xs text-muted-foreground -mt-3">
                  URL que seus clientes usam para agendar.
                </p>
            ...
            <TabsContent value="mensagens" className="space-y-6">
              <div className="card-elevated p-6 space-y-5">
                ...
                <p className="text-xs text-muted-foreground -mt-3">
                  Use <code className="text-accent">{"{nome}"}</code>,{" "}
                  <code className="text-accent">{"{negocio}"}</code>,{" "}
                  <code className="text-accent">{"{servico}"}</code>,{" "}
                  <code className="text-accent">{"{valor}"}</code>,{" "}
                ...
                <F label="Cancelado">
                  <textarea
                    rows={4}
                    value={form.msg_cancelled}
                    onChange={(e) => setForm({ ...form, msg_cancelled: e.target.value })}
                    className={cls}
                    placeholder={
                      "Ola {nome}! Notamos que voce cancelou seu agendamento na {negocio}.\n\nSe precisar de ajuda ou quiser remarcar, e so nos chamar!"
                    }
                  />
                </F>
              </div>
          ...
          <button disabled={save.isPending} className="btn-brand disabled:opacity-60">
